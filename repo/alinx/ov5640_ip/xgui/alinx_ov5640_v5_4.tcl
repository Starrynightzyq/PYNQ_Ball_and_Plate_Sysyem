...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FIFO_GEN"
...
proc update_PARAM_VALUE.FIFO_GEN { PARAM_VALUE.FIFO_GEN } {
	# Procedure called to update FIFO_GEN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FIFO_GEN { PARAM_VALUE.FIFO_GEN } {
	# Procedure called to validate FIFO_GEN
	return true
}
...
proc update_MODELPARAM_VALUE.FIFO_GEN { MODELPARAM_VALUE.FIFO_GEN PARAM_VALUE.FIFO_GEN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FIFO_GEN}] ${MODELPARAM_VALUE.FIFO_GEN}
}

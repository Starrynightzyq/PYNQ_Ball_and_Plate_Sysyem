...
proc create_root_design { parentCell } {
  ...
  set cmos_reset [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cmos_reset ]
  set cmos_xclk_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cmos_xclk_0 ]
  set hdmi_out [ create_bd_intf_port -mode Master -vlnv digilentinc.com:interface:tmds_rtl:1.0 hdmi_out ]

  # Create ports
  set cmos_d_0 [ create_bd_port -dir I -from 7 -to 0 cmos_d_0 ]
  ...
  set cmos_xclk_0 [ create_bd_port -dir O -type clk cmos_xclk_0 ]
  ...
  # Create instance: ov_camera_0, and set properties
  set ov_camera_0 [ create_bd_cell -type ip -vlnv www.alinx.com.cn:user:alinx_ov5640:5.4 ov_camera_0 ]
  set_property -dict [ list \
   CONFIG.BUFFER_DEPTH {2048} \
 ] $ov_camera_0
  ...
  connect_bd_intf_net -intf_net alinx_ov5640_0_m_axis_video [get_bd_intf_pins axis_subset_converter_0/S_AXIS] [get_bd_intf_pins ov_camera_0/m_axis_video]
connect_bd_intf_net -intf_net [get_bd_intf_nets alinx_ov5640_0_m_axis_video] [get_bd_intf_pins axis_subset_converter_0/S_AXIS] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXI_MM2S] [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins ila_2/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net cmos_rst_GPIO [get_bd_intf_ports cmos_reset] [get_bd_intf_pins cmos_rst/GPIO]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports cmos_xclk_0] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net cmos_d_0_1 [get_bd_ports cmos_d_0] [get_bd_pins ov_camera_0/cmos_d]
  connect_bd_net -net cmos_href_0_1 [get_bd_ports cmos_href_0] [get_bd_pins ov_camera_0/cmos_href]
  connect_bd_net -net cmos_pclk_0_1 [get_bd_ports cmos_pclk_0] [get_bd_pins ov_camera_0/cmos_pclk]
  connect_bd_net -net cmos_vsync_0_1 [get_bd_ports cmos_vsync_0] [get_bd_pins ov_camera_0/cmos_vsync]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins cmos_rst/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins ov_camera_0/m_axis_video_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_140M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ov_camera_0/m_axis_video_aresetn] [get_bd_pins rst_processing_system7_0_150M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins clk_wiz_0/reset] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_ports coms_pwdn] [get_bd_pins xlconstant_3/dout]

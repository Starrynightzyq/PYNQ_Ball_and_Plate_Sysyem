...
struct reginfo_8 sensor_ov7725_init_data[] =
{
	{0x12, 0x80},// system clock from PLL, bit[1]
	{0x0c, 0xd0},// system clock from pad, bit[1]
	{0x11, 0x00},// software reset, bit[7]// delay 5ms
	{0x12, 0x06},// software power down, bit[6]
	{SEQUENCE_8_END, 0x00}
};
...
int ov7725_read(XIicPs *IicInstance,u8 addr,u8 *read_buf)
{
	*read_buf=i2c_reg8_read(IicInstance,0x42,addr);
	return XST_SUCCESS;
}

int ov7725_write(XIicPs *IicInstance,u8 addr,u8 data)
{
	return i2c_reg8_write(IicInstance,0x42,addr,data);
}

/* write a array of registers  */
void sensor_ov5640_write_array(XIicPs *IicInstance, struct reginfo *regarray)
{
    int i = 0;
...
/* write a array of registers  */
void sensor_ov7725_write_array(XIicPs *IicInstance, struct reginfo_8 *regarray)
{
    int i = 0;
    while (regarray[i].reg != SEQUENCE_END) {
    	ov7725_write(IicInstance,regarray[i].reg,regarray[i].val);
		i++;
	}
...
{
	sensor_ov7725_write_array(IicInstance,sensor_ov7725_init_data);
	return 0;
}

...
HD_PWD='C:/MyFiles/PYNQ_Ball_and_Plate_Sysyem/vivado_proj/ZYNQ_4/OV_VDMA.runs/system_xlconstant_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconstant_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconstant_1_1.tcl

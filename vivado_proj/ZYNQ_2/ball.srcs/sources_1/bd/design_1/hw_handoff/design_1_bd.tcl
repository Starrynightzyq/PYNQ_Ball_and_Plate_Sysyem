...
proc create_root_design { parentCell } {
  ...
  set cmos_iic_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 cmos_iic_0 ]
  ...
  set cmos_xclk_0 [ create_bd_port -dir O cmos_xclk_0 ]
  set coms_pwdn [ create_bd_port -dir O -from 0 -to 0 coms_pwdn ]
  set hdmi_in_hpd [ create_bd_port -dir O -from 0 -to 0 hdmi_in_hpd ]

  # Create instance: CMOS_Capture_RGB565_0, and set properties
  set block_name CMOS_Capture_RGB565
  set block_cell_name CMOS_Capture_RGB565_0
  if { [catch {set CMOS_Capture_RGB565_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CMOS_Capture_RGB565_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axi_gpio_cmos, and set properties
  set axi_gpio_cmos [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_cmos ]
  ...
  # Create instance: cmos_reset, and set properties
  set cmos_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 cmos_reset ]

  # Create instance: coms_pwdn, and set properties
  set coms_pwdn [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 coms_pwdn ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $coms_pwdn
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXI_MM2S] [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins ila_2/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXI_S2MM] [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM] [get_bd_intf_pins ila_3/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_out_M_AXIS] [get_bd_intf_pins axis_subset_converter_out/M_AXIS] [get_bd_intf_pins ila_1/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports cmos_iic_0] [get_bd_intf_pins processing_system7_0/IIC_0]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M05_AXI [get_bd_intf_pins axi_gpio_cmos/S_AXI] [get_bd_intf_pins ps7_0_axi_periph_GP0/M05_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_vid_in_axi4s_0_video_out] [get_bd_intf_pins axis_subset_converter_in/S_AXIS] [get_bd_intf_pins ila_6/SLOT_0_AXIS]
  ...
  connect_bd_net -net CMOS_Capture_RGB565_0_cmos_frame_data [get_bd_pins CMOS_Capture_RGB565_0/cmos_frame_data] [get_bd_pins ila_5/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net CMOS_Capture_RGB565_0_cmos_frame_de [get_bd_pins CMOS_Capture_RGB565_0/cmos_frame_de] [get_bd_pins ila_5/probe3] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net CMOS_Capture_RGB565_0_cmos_frame_href [get_bd_pins CMOS_Capture_RGB565_0/cmos_frame_href] [get_bd_pins ila_5/probe1] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net CMOS_Capture_RGB565_0_cmos_frame_vsync [get_bd_pins CMOS_Capture_RGB565_0/cmos_frame_vsync] [get_bd_pins ila_5/probe2] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net CMOS_Capture_RGB565_0_cmos_xclk [get_bd_ports cmos_xclk_0] [get_bd_pins CMOS_Capture_RGB565_0/cmos_xclk] [get_bd_pins ila_5/probe6]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_pins clk_wiz_0/clk_25M] [get_bd_pins proc_sys_reset_25M/slowest_sync_clk] [get_bd_pins rgb2dvi_1/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_out/clk]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_video/ip2intc_irpt] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_gpio_cmos_gpio_io_o [get_bd_pins CMOS_Capture_RGB565_0/rst_capture] [get_bd_pins axi_gpio_cmos/gpio_io_o]
  ...
  connect_bd_net -net clk_wiz_0_clk_125M [get_bd_pins clk_wiz_0/clk_125M] [get_bd_pins rgb2dvi_1/SerialClk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rgb2dvi_1/aRst_n]
  connect_bd_net -net cmos_data_0_1 [get_bd_ports cmos_data_0] [get_bd_pins CMOS_Capture_RGB565_0/cmos_data] [get_bd_pins ila_5/probe10]
  connect_bd_net -net cmos_href_0_1 [get_bd_ports cmos_href_0] [get_bd_pins CMOS_Capture_RGB565_0/cmos_href] [get_bd_pins ila_5/probe9]
  connect_bd_net -net cmos_pclk_0_1 [get_bd_ports cmos_pclk_0] [get_bd_pins CMOS_Capture_RGB565_0/cmos_pclk] [get_bd_pins ila_5/probe7]
  connect_bd_net -net cmos_reset_dout [get_bd_ports cmos_reset] [get_bd_pins cmos_reset/dout]
  connect_bd_net -net cmos_vsync_0_1 [get_bd_ports cmos_vsync_0] [get_bd_pins CMOS_Capture_RGB565_0/cmos_vsync] [get_bd_pins ila_5/probe8]
  connect_bd_net -net coms_pwdn_dout [get_bd_ports coms_pwdn] [get_bd_pins coms_pwdn/dout]
  connect_bd_net -net dvi2rgb_1_PixelClk [get_bd_pins CMOS_Capture_RGB565_0/cmos_frame_clken] [get_bd_pins ila_5/probe4] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins v_tc_in/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net dvi2rgb_1_aPixelClkLckd [get_bd_pins CMOS_Capture_RGB565_0/locled] [get_bd_pins axi_gpio_video/gpio2_io_i] [get_bd_pins ila_5/probe5] [get_bd_pins proc_sys_reset_0/aux_reset_in]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_125M/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn1 [get_bd_pins proc_sys_reset_25M/peripheral_aresetn] [get_bd_pins v_tc_out/resetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_cmos/s_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins ila_5/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M00_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M01_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M02_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M03_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M04_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/M05_ACLK] [get_bd_pins ps7_0_axi_periph_GP0/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_in/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon_HP0/ACLK] [get_bd_pins axi_mem_intercon_HP0/M00_ACLK] [get_bd_pins axi_mem_intercon_HP0/S00_ACLK] [get_bd_pins axi_mem_intercon_HP0/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_in/aclk] [get_bd_pins axis_subset_converter_out/aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ila_2/clk] [get_bd_pins ila_3/clk] [get_bd_pins ila_6/clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_133M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins CMOS_Capture_RGB565_0/clk_cmos] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_125M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK3]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_125M/ext_reset_in] [get_bd_pins proc_sys_reset_25M/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_133M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins CMOS_Capture_RGB565_0/rst_n] [get_bd_pins axi_gpio_cmos/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph_GP0/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M04_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M05_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_in/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_cmos/S_AXI/Reg] SEG_axi_gpio_0_Reg1

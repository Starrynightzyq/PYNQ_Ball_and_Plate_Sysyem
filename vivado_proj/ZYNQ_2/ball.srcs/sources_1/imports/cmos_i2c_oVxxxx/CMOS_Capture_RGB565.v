...
(
	...
	input				rst_capture,		//capture reset , active low
	...
	output				cmos_frame_de,		//cmos frame active
...
assign locled = frame_sync_flag;
assign cmos_frame_de = (frame_sync_flag & cmos_frame_href) ? 1'b1 : 1'b0;

assign reset_n = rst_n && rst_capture;
...
always@(posedge cmos_pclk or negedge reset_n)
begin
	if(!reset_n)
		begin
		cmos_vsync_r <= 0;
...
assign	cmos_frame_data = (frame_sync_flag & cmos_frame_href) ? {cmos_frame_data_r[15:11],cmos_frame_data_r[15:13],cmos_frame_data_r[10:5],cmos_frame_data_r[10:9],cmos_frame_data_r[4:0],cmos_frame_data_r[4:2]} : 16'd0;
